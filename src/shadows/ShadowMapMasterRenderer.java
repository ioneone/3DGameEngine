...
public class ShadowMapMasterRenderer {
	...
	private Matrix4f lightViewMatrix = new Matrix4f().identity();
	private Matrix4f projectionViewMatrix = new Matrix4f().identity();
	 ...
	 */
	public void render(Map<TexturedModel, List<Entity>> entities, PointLight sun) {
		shadowBox.update();
	...
	public Matrix4f getToShadowMapSpaceMatrix() {
		...
		offset.mul(projectionViewMatrix, matrix);
		return matrix;
	}
