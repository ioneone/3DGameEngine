...
public class HeightGenerator {
    ...
    private float getInterpolatedNoise(float x, float z) {
        ...
        float v1 = getSoothNoise(intX, intZ);
        float v2 = getSoothNoise(intX + 1, intZ);
        float v3 = getSoothNoise(intX, intZ + 1);
        float v4 = getSoothNoise(intX + 1, intZ + 1);
    ...
    private float getSoothNoise(int x, int z) {
    ...
    private float getNoise(int x, int z) {
        random.setSeed(x * 49632 + z * 32516 + seed);
