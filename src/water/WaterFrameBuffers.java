...
public class WaterFrameBuffers {
    ...
    private int createFrameBuffer() { // create custom frame buffer
        int frameBufferID = GL30.glGenFramebuffers();
        //generate name for frame buffer
        GL30.glBindFramebuffer(GL30.GL_FRAMEBUFFER, frameBufferID); // to do something with frame buffer, you have to bind it
